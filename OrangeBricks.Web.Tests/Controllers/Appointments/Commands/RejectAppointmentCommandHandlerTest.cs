...
{
    [TestFixture]
    public class RejectAppointmentCommandHandlerTest
    {
        public RejectAppointmentCommandHandler handler;
        ...
        public void SetUp()
        {
            ...
            this.handler = new RejectAppointmentCommandHandler(context);
        }
        ...
        public void HandleShouldRejectAppointment()
        {
            ...
            Assert.True(appointment.Status == ViewingAppointmentStatus.Rejected);
        }
    }
}
